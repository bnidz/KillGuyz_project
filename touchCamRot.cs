...
public class touchCamRot : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        transform.Rotate(Input.GetAxis("Mouse Y") * speed * Time.deltaTime, Input.GetAxis("Mouse X") * speed * Time.deltaTime, Quaternion.identity.z);
        ...
        if (enableRotation && (Input.GetMouseButton(1)))
        {
            ...
            Debug.Log("mosux " + Input.GetAxis("Mouse X"));

            //transform.eulerAngles = new Vector3(0, Mathf.Atan2(Input.GetAxis("Mouse Y"), Input.GetAxis("Mouse X")) * 180 / Mathf.PI, 0);
            // angle = Mathf.Atan2(0, Input.GetAxis("Mouse X")) * Mathf.Rad2Deg;
